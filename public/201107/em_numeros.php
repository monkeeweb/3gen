...
<html lang="pt">
	...
	<head>
		...
		<meta charset="UTF-8">
		<title>Em Núm3ros :: Strategy At Work :: Julho de 2011</title>
		<meta name="url" content="http://www.strategyatwork.com.br" />
		<meta name="description" content="Newsletter mensal Strategy At Work" />
		<meta name="keywords" content="3gen gestão estratégica, execução da estratégia, strategy at work, em números, núm3ros" />
		...
		<div id="container">
				...
				<div id="left_column">
					...
					<nav>
						...
						<div id="button-1"><a href="index.php" title="Editorial"><img src="images/layout/botao_editorial.jpg" alt="Editorial" width="273" height="46" /></a></div>
						...
						<div id="button-7"><img src="images/layout/botao_em_numeros_selected.jpg" alt="Em núm3ros" width="273" height="46" /></div>
				...
				<div id="right_column">
					...
					<div id="content_area">
						...
						<div id="content_title"><img src="images/layout/content_title_em_numeros.jpg" alt="Em Números" width="607" height="75" /></div>
						
						<div class="espaco_hor_40px"><img src="images/layout/blank.gif" alt="" width="1" height="1" /></div>
						
						<div id="content_text">
						
							<h3>O mercado de saúde em números</h3>
							
							<p><strong>Por Otávio Calixto</strong></p>
							
							<p><span class="numero_destaque">4%</span> é o percentual de gastos em saúde no Brasil em relação ao PIB</p>
							
							<p><span class="numero_destaque">22%</span> é a penetração dos planos de saúde na população brasileira</p>
							
							<p><span class="numero_destaque">80%</span> é a quantidade de pessoas que tiveram problemas com planos de saúde em 2010</p>
							
							<p><span class="numero_destaque">840</span> reais é o gasto médio do brasileiro com saúde por ano</p>
							
							<p><span class="numero_destaque">1.700</span> operadoras de planos de saúde atuam no mercado brasileiro</p>
							
							<p><span class="numero_destaque">44 milhões</span> de vidas foram beneficiadas com a nova regulação da ANS sobre procedimentos </p>
							
							<p><span class="numero_destaque">108 milhões</span> de dólares foi o valor médio das operações de fusão e aquisição do setor em 2010</p>
