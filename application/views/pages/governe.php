<?php $this->lang->load('governe', CURRENT_LANGUAGE); ?>

<div role="main">
	<h2 class="ir topoConsultoria topo"><div class="container"><?php echo $this->lang->line('title0'); ?></div></h2>
	<div class="container clearfix">
		<div class="colInterna">
			...
			<p class="red"><strong><?php echo $this->lang->line('title2'); ?></strong></p>
			...
			<p class="red"><strong><?php echo $this->lang->line('title3'); ?></strong></p>

			<p><?php echo $this->lang->line('line7'); ?></p>

			<p><?php echo $this->lang->line('line8'); ?></p>

			<p><?php echo $this->lang->line('line9'); ?></p>
